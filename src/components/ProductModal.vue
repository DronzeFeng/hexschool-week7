          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <div v-if="Array.isArray(product.imagesUrl)">
                <template v-for="(image, key) in product.imagesUrl" :key="key + '3345678'">
                  <div class="mb-3">
                ...
                <button v-if="!product.imagesUrl.length || product.imagesUrl[product.imagesUrl.length - 1]" class="btn btn-outline-primary btn-sm d-block w-100" @click="product.imagesUrl.push('')">
                  新增圖片
                </button>
                <button v-else class="btn btn-outline-danger btn-sm d-block w-100" @click="product.imagesUrl.pop()">
                  刪除圖片
                </button>
              </div>
            </div>
            <div class="col-sm-8">
              ...
              <div class="mb-3">
                ...
                <textarea id="description" type="text" class="form-control" placeholder="請輸入說明內容" v-model="product.content">
                </textarea>
              </div>
              <div class="mb-3">
